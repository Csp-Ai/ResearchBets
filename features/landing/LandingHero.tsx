...
export function LandingHero() {
  ...
  return (
    ...
    >
      ...
      >
        <motion.div variants={staggerItem} className="terminal-shell-outer relative w-[79vw] max-w-[1320px] rounded-2xl p-2 sm:p-3">
          <div
        ...
        <div className="pointer-events-none absolute left-0 top-0 z-30 w-full max-w-[560px] px-2 sm:px-0">
          ...
          <motion.h1 variants={staggerItem} className="mt-2 max-w-[11ch] text-4xl font-semibold leading-[1.05] sm:text-5xl lg:text-6xl">
            Run the slip. Isolate fragility. Decide with precision.
          </motion.h1>
          <motion.p variants={staggerItem} className="mt-4 max-w-md text-sm text-slate-200">

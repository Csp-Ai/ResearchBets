...
const buildBoardRow = (entry: Record<string, unknown>, index: number): BoardRow => {
  ...
  return {
    ...
    l10Avg: typeof entry.l10Avg === 'number' ? entry.l10Avg : undefined,
    threesAttL1: typeof entry.threesAttL1 === 'number' ? entry.threesAttL1 : undefined,
    threesAttL3Avg: typeof entry.threesAttL3Avg === 'number' ? entry.threesAttL3Avg : undefined,
    threesAttL5Avg: typeof entry.threesAttL5Avg === 'number' ? entry.threesAttL5Avg : undefined,
    fgaL1: typeof entry.fgaL1 === 'number' ? entry.fgaL1 : undefined,
    fgaL3Avg: typeof entry.fgaL3Avg === 'number' ? entry.fgaL3Avg : undefined,
    fgaL5Avg: typeof entry.fgaL5Avg === 'number' ? entry.fgaL5Avg : undefined,
    ...
    attemptsSource: entry.attemptsSource === 'live' || entry.attemptsSource === 'cached' || entry.attemptsSource === 'demo' ? entry.attemptsSource : entry.attemptsSource === 'heuristic' ? 'heuristic' : undefined,

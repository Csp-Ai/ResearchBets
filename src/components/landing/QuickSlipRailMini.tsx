...
export function QuickSlipRailMini({
  ...
  return (
    <section className="rounded-2xl border border-white/10 bg-slate-900/70 p-4 sm:p-5" aria-label="quick-slip-rail-mini">
      <h2 className="text-base font-semibold text-white sm:text-lg">QuickSlip Rail</h2>
      ...
      {slip.length === 0 ? (
        <div className="mt-3 rounded-lg border border-dashed border-white/20 p-3 text-sm text-slate-300">
      ...
      <div className="mt-4 flex flex-wrap gap-2">
        <Link href={stressHref} className="rounded-md bg-cyan-300 px-3 py-2 text-sm font-semibold text-slate-950 transition hover:bg-cyan-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-cyan-300/70">Stress Test</Link>

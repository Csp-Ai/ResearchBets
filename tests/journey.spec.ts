...
test('journey 1: Landing → Board Analyze → Stress Test Scout → Build Slip → Control Room', async ({ page }: { page: any }) => {
...
test('journey 2: Landing → Analyze my slip → Ingest paste → Research', async ({ page }: { page: any }) => {
  await page.goto('/?sport=NBA&tz=America/Phoenix&mode=live');
